require_relative '../../../../lib/tyrano_dsl/intermediate/words/set_title_screen_background'
require_relative 'words_base_test'

class IntermediateWords::SetTitleScreenBackgroundTest < IntermediateWords::WordsBaseTest

  def setup
    super
    @set_title_screen_background = TyranoDsl::Intermediate::Words::SetTitleScreenBackground.new
  end
