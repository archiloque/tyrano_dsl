require_relative '../../../../lib/tyrano_dsl/intermediate/words/start_scene'
require_relative 'words_base_test'

class IntermediateWords::StartSceneTest < IntermediateWords::WordsBaseTest

  def setup
    super
    @start_scene = TyranoDsl::Intermediate::Words::StartScene.new
  end
