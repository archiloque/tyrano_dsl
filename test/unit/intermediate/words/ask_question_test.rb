require_relative '../../../../lib/tyrano_dsl/intermediate/words/ask_question'
require_relative 'words_base_test'

class IntermediateWords::AskQuestionTest < IntermediateWords::WordsBaseTest

  def setup
    super
    @ask_question = TyranoDsl::Intermediate::Words::AskQuestion.new
  end
