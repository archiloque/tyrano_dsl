require_relative '../../../../lib/tyrano_dsl/intermediate/words/declare_background'
require_relative 'words_base_test'

class IntermediateWords::DeclareBackgroundTest < IntermediateWords::WordsBaseTest

  def setup
    super
    @declare_background = TyranoDsl::Intermediate::Words::DeclareBackground.new
  end
