require_relative '../../../../lib/tyrano_dsl/intermediate/words/declare_character'
require_relative 'words_base_test'

class IntermediateWords::DeclareCharacterTest < IntermediateWords::WordsBaseTest

  def setup
    super
    @declare_character = TyranoDsl::Intermediate::Words::DeclareCharacter.new
  end
