require_relative '../../../../lib/tyrano_dsl/intermediate/words/declare_label'
require_relative 'words_base_test'

class IntermediateWords::DeclareLabelTest < IntermediateWords::WordsBaseTest

  def setup
    super
    @declare_label = TyranoDsl::Intermediate::Words::DeclareLabel.new
  end
