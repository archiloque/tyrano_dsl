require_relative '../../../../lib/tyrano_dsl/validation/words/show_character'
require_relative 'words_base_test'

class ValidationWords::ShowCharacterTest < ValidationWords::WordsBaseTest

  def setup
    super
    @show_character = TyranoDsl::Validation::Words::ShowCharacter.new
  end
