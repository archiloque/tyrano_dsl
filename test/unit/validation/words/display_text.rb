require_relative '../../../../lib/tyrano_dsl/validation/words/display_text'
require_relative 'words_base_test'

class ValidationWords::DisplayTextTest < ValidationWords::WordsBaseTest

  def setup
    super
    @display_text = TyranoDsl::Validation::Words::DisplayText.new
  end
