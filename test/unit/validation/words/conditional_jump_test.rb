require_relative '../../../../lib/tyrano_dsl/validation/words/conditional_jump'
require_relative 'words_base_test'

class ValidationWords::ConditionalJumpTest < ValidationWords::WordsBaseTest

  def setup
    super
    @conditional_jump = TyranoDsl::Validation::Words::ConditionalJump.new
  end
