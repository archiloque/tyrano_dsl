...
require_relative '../../../../lib/tyrano_dsl/export_tyrano/writing_words/show_message_window'
...
class EGWritingWordsShowMessageWindowTest < Minitest::Test
  ...
  def test_no_current_scene
    ...
    show_message_window = TyranoDsl::ExportTyrano::WritingWords::ShowMessageWindow.new
