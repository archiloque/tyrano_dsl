...
require_relative '../../../../lib/tyrano_dsl/export_tyrano/writing_words/conditional_jump'

class EGWritingWordsConditionalJumpTest < Minitest::Test
  ...
  def test_no_current_scene
    ...
    conditional_jump = TyranoDsl::ExportTyrano::WritingWords::ConditionalJump.new
