...
require_relative '../../../../lib/tyrano_dsl/export_tyrano/writing_words/set_character_stance'
...
class EGWritingWordsSetCharacterStanceTest < Minitest::Test
  ...
  def test_no_current_scene
    ...
    set_character_stance = TyranoDsl::ExportTyrano::WritingWords::SetCharacterStance.new
