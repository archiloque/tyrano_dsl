...
require_relative '../../../../lib/tyrano_dsl/export_tyrano/writing_words//hide_message_window'
...
class EGWritingWordsHideMessageWindowTest < Minitest::Test
  ...
  def test_no_current_scene
    ...
    hide_message_window = TyranoDsl::ExportTyrano::WritingWords::HideMessageWindow.new
