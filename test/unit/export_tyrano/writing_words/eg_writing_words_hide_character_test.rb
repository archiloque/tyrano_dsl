...
require_relative '../../../../lib/tyrano_dsl/export_tyrano/writing_words/hide_character'

class EGWritingWordsHideCharacterTest < Minitest::Test
  ...
  def test_no_current_scene
    ...
    hide_character = TyranoDsl::ExportTyrano::WritingWords::HideCharacter.new
