...
require_relative '../../../../lib/tyrano_dsl/export_tyrano/writing_words/update_variable'

class EGWritingWordsUpdateVariableTest < Minitest::Test
  ...
  def test_no_current_scene
    ...
    update_variable = TyranoDsl::ExportTyrano::WritingWords::UpdateVariable.new
